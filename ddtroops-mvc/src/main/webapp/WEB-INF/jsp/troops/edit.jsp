...
<my:pagetemplate title="Edit troop">
<jsp:attribute name="body">
  <c:set var="end" value="troops"/>

    <form:form method="post" action="${pageContext.request.contextPath}/${end}/edit/${troopEdit.id}"
               modelAttribute="troopEdit" cssClass="form-horizontal">
